...
public class LinkedBinaryTree<E> implements BinaryTree<E> {
	...
	public LinkedBinaryTree<E> mirror() {
		...
		return reversed.mirror(this.root());
	}
	
	public LinkedBinaryTree<E> mirror(Position<E> p){
		LinkedBinaryTree<E> reversed = new LinkedBinaryTree<E>();
		Node<E> node = (Node<E>)p;
		reversed.addRoot(p.getElement());
		LinkedBinaryTree<E> leftBranch = new LinkedBinaryTree<E>();
		LinkedBinaryTree<E> rightBranch = new LinkedBinaryTree<E>();
		if(node.getLeft() != null)
		{
			rightBranch =  mirror(node.getLeft());
		}
		if(node.getRight() != null)
		{
			leftBranch = mirror(node.getRight());
		}
		reversed.attach(reversed.root(), leftBranch, rightBranch);
		return reversed;
	}
